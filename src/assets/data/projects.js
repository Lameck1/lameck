const projects = [
  {
    ...
    title: 'Cardinal',
    image:
      'https://res.cloudinary.com/dssc4mht3/image/upload/v1702947254/cardinal_vjapnb.png',
    description:
      'An intelligent tool that can analyze data and produce natural-language responses to user queries. The app can also visualize data. This project is still under developments and its repo is not yet public.',
    technologies: [
      'React',
      'Python',
      'JavaScript',
    ...
    githubLink: '',
    liveLink: 'https://cosmic-wisp-4bb29b.netlify.app/',
  },
  {
    id: 2,
    title: 'Office-Booking',
    image:
      'https://res.cloudinary.com/dssc4mht3/image/upload/v1653645136/office-booking_u5rmlj.png',
    description:
  ...
  },
  {
    ...
    title: 'R-detective',
    image:
      'https://res.cloudinary.com/dssc4mht3/image/upload/v1617364073/r-detective_e1awc3.png',
    description:
  ...
  },
  {
    ...
    title: 'Crypto-Stats',
    image:
      'https://res.cloudinary.com/dssc4mht3/image/upload/v1653644021/crypto-stats_zwl7bf.png',
    description:
  ...
  },
  {
    ...
    title: 'To-Do-List',
    image:
      'https://res.cloudinary.com/dssc4mht3/image/upload/v1653654938/to-do_ic5bat.png',
    description:
